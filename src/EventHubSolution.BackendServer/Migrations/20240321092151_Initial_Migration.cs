        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_FileStorages_IconImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Events_FileStorages_CoverImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventSubImages_FileStorages_ImageId",
                        column: x => x.ImageId,
                        principalTable: "FileStorages",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteEvents", x => new { x.EventId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailAttachments", x => new { x.AttachmentId, x.EmailContentId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmailAttachments_FileStorages_AttachmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_IconImageId",
                table: "Categories",
                column: "IconImageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventSubImages_ImageId",
                table: "EventSubImages",
                column: "ImageId");
